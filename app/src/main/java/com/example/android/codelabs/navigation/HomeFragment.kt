...
class HomeFragment : Fragment() {
    ...
    lateinit var navigate_destination_button: Button
    lateinit var navigate_action_button: Button
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        navigate_destination_button = view.findViewById(R.id.navigate_destination_button)
        navigate_action_button = view.findViewById(R.id.navigate_action_button)
